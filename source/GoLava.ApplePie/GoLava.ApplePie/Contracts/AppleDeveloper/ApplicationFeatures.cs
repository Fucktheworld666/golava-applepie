...
namespace GoLava.ApplePie.Contracts.AppleDeveloper
{
    public class ApplicationFeatures
    {
        ...
        [FormDataProperty(PropertyName = "pass")]
        public bool? Passbook { get; set; }

        [JsonProperty("dataProtection"), FormDataProperty(PropertyName = "dataProtectionPermissionLevel")]
        public virtual DataProtectionPermissionLevel? DataProtectionPermissionLevel { get; set; }
